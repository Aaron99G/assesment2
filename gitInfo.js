...
//CODE HERE
let gitDefinition = 'Git is  an application for Microsoft Windows environments which provides an emulation layer for a Git command line experience.';
...
const clone = {
    ...
    code: 'git clone (the address of repo)'
}
console.log(clone);
...
//CODE HERE
const add = {
    description: 'add the new content/files to the index',
    code: 'git add'
};
console.log(add);
